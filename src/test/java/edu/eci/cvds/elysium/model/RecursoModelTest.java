...
//     @BeforeEach
//     public void setUp() {
//         recurso = new Recurso("Recurso1", 10, Arrays.asList("Especificacion1", "Especificacion2"));
//     }

//     @Test
//     public void testCrearRecurso() {
//         Recurso nuevoRecurso = recurso.crearRecurso("Recurso2", 5, Arrays.asList("Especificacion3"));
