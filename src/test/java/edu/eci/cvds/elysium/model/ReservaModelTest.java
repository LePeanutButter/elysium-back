...
//     @BeforeEach
//     public void setUp() {
//         reserva = new ReservaModel("1", LocalDate.now(),8.0, DiaSemanaModel.LUNES, "Meeting", "A101", true, 3);
//     }

//     @Test
//     public void testCrearReserva() {
//         ReservaModel nuevaReserva = reserva.crearReserva("2", LocalDate.now().plusDays(1),8.0, DiaSemanaModel.MARTES, "Conference", "B202", false, 2);
...
//         reserva.actualizar("1", 'f', LocalDate.now().plusDays(2),8.0, null, "", false, 6);
//         assertEquals(LocalDate.now().plusDays(2), reserva.getFechaReserva());

//         reserva.actualizar("1", 'd', null,8.0, DiaSemanaModel.MIERCOLES, null, false, null);
//         assertEquals(DiaSemanaModel.MIERCOLES, reserva.getDiaSemana());

//         reserva.actualizar("1", 's',8.0, null, null, "C303", false, null);
//         assertEquals("C303", reserva.getIdSalon());

//         reserva.actualizar("1", 'b', 8.0,null, null, null, false, null);
